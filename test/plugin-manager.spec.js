...
describe('removePlugins', function() {
    ...
    it('should remove all plugins passed in an npm dependency object', function(done) {
        pm.removePlugins(plugins)
            .then(function() {
                npm.load({
                    // logLevel: 'silent'
                }, function(err) {
